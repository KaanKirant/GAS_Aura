...
void AAuraPlayerController::AutoRun()
{
	...
	if (APawn* ControlledPawn = GetPawn())
	{
		...
		const float DistanceToDestionation = (LocationOnSpline - CachedDestination).Length();
		if (DistanceToDestionation <= AutoRunAcceptanceRadius)
		{
			bAutoRunning = false;
		}
	}
...
void AAuraPlayerController::CursorTrace()
{
	...
	/*
	 * Line trace from cursor. There are several scenairos:
